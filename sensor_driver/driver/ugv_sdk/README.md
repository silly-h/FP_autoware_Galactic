...
5. Testing command
    ```
    # receiving data from can1
    $ candump can1
    # send data to can1
    $ cansend can1 001#1122334455667788
    ```
...
If you're using a different CAN interface, replace "can1" with the name of your interface.
